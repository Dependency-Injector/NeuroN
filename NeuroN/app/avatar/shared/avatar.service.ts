...
export class AvatarService {
    private azureTasksApiUrl = 'http://apineuro.azurewebsites.net/api/avatar';
    private localApiUrl = 'http://localhost:2243/api/avatar';
    
    private stream: BehaviorSubject<IAvatar>;
    private _avatar: IAvatar;
    private requestOptions: RequestOptions;
    
    constructor(private http: Http, private apiHelper: ApiHelper) {
        this.stream = new BehaviorSubject(new Avatar());
